...
<html>
<head>
<title>QueriesOverflow | Admin </title>
...
<form action="admin_login.php" method="POST" class="logout">
...
<?php 
ob_flush();}
else{echo '<meta http-equiv="refresh" content="1; URL=admin_login.php">'; }
?>
